...
const Home: NextPage = () => {
  return (
    <Box>
      <SEO
        title="Editor.html"
        description="cross-platform desktop app for learning and practicing
      ...
      <Features
        ...
        features={[
          ...
          },
          {
            ...
            icon: FiGrid,
            description:
              "Organize and manage code effortlessly with a seamless design.",
            iconPosition: "left",
            delay: 1,
          },
          {
            ...
            icon: FiThumbsUp,
            description:
              "Boost efficiency with an intuitive interface and real-time preview.",
            iconPosition: "left",
            delay: 1.1,
          },
        ]}
...
export async function getStaticProps() {
  return {
    props: {
      announcement: {
        title: "Give this project a star on GitHub 🚀 ",
        description:
          '<img src="https://img.shields.io/github/stars/adityavijay21/editor.html?style=social&label=Star" />',
